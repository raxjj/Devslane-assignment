  ...
  return (
    <div className="border rounded-lg p-4 w-64 shadow-md bg-white relative transform transition duration-300 hover:-translate-y-2 hover:shadow-xl">
      ...
      <div className="mt-1">
       ...
       <button
          onClick={() => handleAddToCart({ title, image, price, sku })}
          className="border border-gray-500 px-3 py-1 rounded-lg bg-green-500 hover:bg-green-700 text-white active:scale-95"
        >
          Add to Cart
        </button>
